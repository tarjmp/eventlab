                ...
                <form method="POST" action="{{ route('event.store') }}">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" name="all-day-event" type="checkbox" value="all-day-event" id="all-day-event"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4 col-6">
                            <input id="start-date" type="date"
                                   class="form-control{{ $errors->has('start-date') ? ' is-invalid' : '' }}" name="start-date"
                        ...
                        <div class="col-md-4 col-6">
                            <input id="start-time" name="start-time" type="time" class="form-control {{ $errors->has('start-time') ? ' is-invalid' : '' }}" value="{{ old('start-time', '18:00') }}" step="60">
                    ...
                    <div class="form-group row" id="end-row">
                        ...
                        <div class="col-md-4 col-6">
                            <input id="end-date" type="date"
                                   class="form-control{{ $errors->has('end-date') ? ' is-invalid' : '' }}" name="end-date"
                        ...
                        <div class="col-md-4 col-6">
                            <input id="end-time" name="end-time" type="time" class="form-control {{ $errors->has('end-time') ? ' is-invalid' : '' }}" value="{{ old('end-time', '18:00') }}" step="60">
